...
public class ModelBuilder3D {
  ...
  public String[] getFfTypes(){
	 ...
	 */
	private IRingSet getRingSetOfAtom(@SuppressWarnings("rawtypes") List ringSystems, IAtom atom) {
	 ...
	 */
	private void layoutMolecule(@SuppressWarnings("rawtypes") List ringSetMolecule, IMolecule molecule, AtomPlacer3D ap3d, AtomTetrahedralLigandPlacer3D atlp3d, AtomPlacer atomPlacer) throws CDKException, IOException, CloneNotSupportedException {
