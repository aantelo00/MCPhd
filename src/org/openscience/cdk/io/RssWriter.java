...
public class RssWriter extends DefaultChemObjectWriter {
    ...
    public boolean accepts(@SuppressWarnings("rawtypes") Class classObject) {
		return true;
	}
	 ...
	 */
	public void setDatemap(@SuppressWarnings("rawtypes") Map datemap) {
	 ...
	 */
	public void setLinkmap(@SuppressWarnings("rawtypes") Map linkmap) {
	 ...
	 */
	public void setTitlemap(@SuppressWarnings("rawtypes") Map titlemap) {
	 ...
	 */
	public void setCreatormap(@SuppressWarnings("rawtypes") Map creatormap) {
	 ...
	 */
	public void setMultiMap(@SuppressWarnings("rawtypes") Map multiMap) {
	 ...
	 */
	public void setInchimap(@SuppressWarnings("rawtypes") Map inchimap) {
