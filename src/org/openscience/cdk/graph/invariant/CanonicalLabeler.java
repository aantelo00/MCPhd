...
public class CanonicalLabeler {
   ...
   */
  private void step2(@SuppressWarnings("rawtypes") ArrayList v, IAtomContainer atoms) {
...
private void step3(@SuppressWarnings("rawtypes") ArrayList v, IAtomContainer atoms) {
    sortArrayList(v);
    rankArrayList(v);
    if (!isInvPart(v)) {
      step2(v, atoms);
...
private ArrayList createInvarLabel(IAtomContainer atomContainer) {
   ...
   * @param v the invariance pair vector
   */
  private void primeProduct(@SuppressWarnings("rawtypes") ArrayList v, IAtomContainer atomContainer) {
    @SuppressWarnings("rawtypes")
   ...
   *  @param v the invariance pair vector
   */
  private void rankArrayList(@SuppressWarnings("rawtypes") ArrayList v) {
    int num = 1;
   ...
   */
  private boolean isInvPart(@SuppressWarnings("rawtypes") ArrayList v) {
    if (((InvPair) v.get(v.size()-1)).getCurr() == v.size())
      return true;
    @SuppressWarnings("rawtypes")
	Iterator it = v.iterator();
   ...
   * @param v the invariance pair vector
   */
  private void breakTies(@SuppressWarnings("rawtypes") ArrayList v) {
    @SuppressWarnings("rawtypes")
	Iterator it = v.iterator();
    InvPair curr;
    InvPair last = null;
