...
class ChiIndexUtils {
     ...
     */
    public static double evalValenceIndex(IAtomContainer atomContainer, @SuppressWarnings("rawtypes") List fragList) throws CDKException {
        try {
     ...
     */
    private static List<List<Integer>> getUniqueBondSubgraphs(@SuppressWarnings("rawtypes") List subgraphs, IAtomContainer ac) {
