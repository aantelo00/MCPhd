...
public class LipoTopologicDescriptor implements IHybridDescriptor {
...
//    private static final String[] strings = new String[] {"ALogP", "ALogp2", "AMR"};
    ...
    public LipoTopologicDescriptor() throws CDKException {
...
//                    frags[1]++;
                    ...
                    if (atomoAux.getSymbol().equals("H"))
                    {
//                        frags[htype]++;
...
//                frags[2]++;
                alogpfrag[i] = 2;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[2] + perturbacion);
            } else if (CarbonCount == 1 && HeteroCount == 1) {
//                frags[6]++;
                alogpfrag[i] = 6;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[6] + perturbacion);
            } else if (CarbonCount == 0 && HeteroCount == 2) {
//                frags[7]++;
                alogpfrag[i] = 7;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[7] + perturbacion);
            }
        }
    }
...
//                frags[3]++;
                alogpfrag[i] = 3;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[3] + perturbacion);
            } else if (CarbonCount == 2 && HeteroCount == 1) {
//                frags[8]++;
                alogpfrag[i] = 8;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[8] + perturbacion);
            } else if (CarbonCount == 1 && HeteroCount == 2) {
//                frags[9]++;
                alogpfrag[i] = 9;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[9] + perturbacion);
            } else if (CarbonCount == 0 && HeteroCount == 3) {
//                frags[10]++;
                alogpfrag[i] = 10;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[10] + perturbacion);
            }
        }
    }
...
//                frags[4]++;
                alogpfrag[i] = 4;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[4] + perturbacion);
            } else if (CarbonCount == 3 && HeteroCount == 1) {
//                frags[11]++;
                alogpfrag[i] = 11;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[11] + perturbacion);
            } else if (CarbonCount == 2 && HeteroCount == 2) {
//                frags[12]++;
                alogpfrag[i] = 12;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[12] + perturbacion);
            } else if (CarbonCount == 1 && HeteroCount == 3) {
//                frags[13]++;
                alogpfrag[i] = 13;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[13] + perturbacion);
            } else if (CarbonCount == 0 && HeteroCount == 4) {
//                frags[14]++;
                alogpfrag[i] = 14;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[14] + perturbacion);
            }
        }
    }
...
//            frags[htype]+=2;
            ...
            atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[15] + perturbacion);
        }
    }
...
//                frags[37]++;
                alogpfrag[i] = 37;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[37] + perturbacion);
            } else {
//                frags[36]++;
                alogpfrag[i] = 36;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[36] + perturbacion);
            }
        } else {
            if (HaveCsX) {
//                frags[18]++;
                alogpfrag[i] = 18;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[18] + perturbacion);
            } else {
//                frags[16]++;
                alogpfrag[i] = 16;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[16] + perturbacion);
            }
        }
    }
...
//                frags[39]++;
                alogpfrag[i] = 39;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[39]);
            } else if (AromaticCount == 0) {
                if (RCount == 1 && XCount == 1) {
//                    frags[40]++;
                    alogpfrag[i] = 40;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[40]);
                } else if (RCount == 0 && XCount == 2) {
//                    frags[41]++;
                    alogpfrag[i] = 41;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[41]);
                } else {
//                    frags[38]++;
                    alogpfrag[i] = 38;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[38]);
                }
...
//                frags[17]++;
                alogpfrag[i] = 17;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[17]);
            } else if (RCount == 1 && XCount == 1) {
//                frags[19]++;
                alogpfrag[i] = 19;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[19]);
            } else if (RCount == 0 && XCount == 2) {
//                frags[20]++;
                alogpfrag[i] = 20;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[20]);
            }
        }
...
//            frags[21]++;
            ...
            int htype = getHAtomType(atomContainer.getAtom(i), ca);
//            frags[htype]++;
            ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[21] + fragval[htype]);
        } else if (fragment[i].equals("SddC")) {
            if (((IAtom)ca.get(0)).getSymbol().equals("C") && ((IAtom)ca.get(1)).getSymbol().equals("C")) {// R==C==R
//                frags[22]++;
                alogpfrag[i] = 22;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[22]);
...
//                frags[23]++;
                alogpfrag[i] = 23;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[23]);
            } else if (!HaveCsX) { // #C-R
//                frags[22]++;
                alogpfrag[i] = 22;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[22]);
...
//            frags[24]++;
            alogpfrag[i] = 24;
            atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[24] + fragval[htype]);
            return;
        }
...
//                frags[30]++;
                alogpfrag[i] = 30;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[30] + fragval[htype]);
            } else { // X--CH...X
//                frags[42]++;
                alogpfrag[i] = 42;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[42] + fragval[htype]);
            }
...
//                frags[27]++;
                alogpfrag[i] = 27;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[27] + fragval[htype]);
            } else {// R--CH...X
//                frags[33]++;
                alogpfrag[i] = 33;
                atomContainer.getAtom(i).setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[33] + fragval[htype]);
...
//                    frags[31]++;
                    alogpfrag[i] = 31;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[31]);
                } else { // X--CX--X
//                    frags[32]++;
                    alogpfrag[i] = 32;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[32]);
                }
...
//                    frags[43]++;
                    alogpfrag[i] = 43;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[43]);

                } else { // X--CX...X
//                    frags[44]++;
                    alogpfrag[i] = 44;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[44]);
                }
...
//                frags[25]++;
                alogpfrag[i] = 25;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[25]);
            } else { // R--CX--R
//                frags[26]++;
                alogpfrag[i] = 26;
                ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[26]);
            }
...
//                    frags[28]++;
                    alogpfrag[i] = 28;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[28]);
                } else { // R--CX--X
//                    frags[29]++;
                    alogpfrag[i] = 29;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[29]);
                }
...
//                    frags[34]++;
                    alogpfrag[i] = 34;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[34]);

                } else { // R--CX...X
//                    frags[35]++;
                    alogpfrag[i] = 35;
                    ai.setProperty(IHybridDescriptor.Descriptor.LIPOINTRINSICVALUE, fragval[35]);
                }
            }
        }
    }
	...
	private int getHAtomType(IAtom ai, @SuppressWarnings("rawtypes") java.util.List connectedAtoms)
    {
...
//                frags[58]++;
	...
	private void calcGroup059_060_063(int i) {
        ...
        if (!fragment[i].equals("SssO") && !fragment[i].equals("aaO"))
            return;
...
//        results.add(ret[1]);
//        results.add(ret[2]);
        double total = updateLipoTopologicValues();
        this.container.setProperty(IHybridDescriptor.Descriptor.TOTALLIPOTOPOLOGICAL, total);
	...
	private double updateLipoTopologicValues() {
		...
		for (int i = 0; i < nAtomos; i++) {
			...
			if(!atomoOrigen.getSymbol().equals("H")){
				...
				atomoOrigen.setProperty(IHybridDescriptor.Descriptor.LIPOTOPOLOGICAL, valorEstateIntAtomoOrigen + efecto);
    ...
    public String[] getDescriptorNames() {
        return new String[]{"Lipo topological descriptor"};
    }
