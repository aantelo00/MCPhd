...
public class SimpleCycleBasis {
	...
	public SimpleCycleBasis (List<SimpleCycle> cycles, @SuppressWarnings("rawtypes") List edgeList, UndirectedGraph graph) {
...
//	}
	...
	private class AuxiliaryGraph2 extends SimpleGraph {
		...
		AuxiliaryGraph2(Graph graph, @SuppressWarnings("rawtypes") List edgeList, boolean[] ui, boolean[] uj) {
			g = graph;
			this.ui = ui;
			this.uj = uj;
		}
