...
//	}
	 ...
	 *      first pass.
	 */
	private boolean isRingOpening(IAtom a1, @SuppressWarnings("rawtypes") List v)
	{
        for (BrokenBond bond : brokenBonds) {
            for (Object aV : v) {
...
//	}
	...
	private void createDFSTree(IAtom a, @SuppressWarnings("rawtypes") List tree, IAtom parent, IAtomContainer container)
	{
		tree.add(a);
		@SuppressWarnings("rawtypes")
