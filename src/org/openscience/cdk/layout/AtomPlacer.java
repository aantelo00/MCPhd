...
//        }
     ...
     */
    @SuppressWarnings("unchecked")
	public  void breadthFirstSearch(IAtomContainer ac, @SuppressWarnings("rawtypes") Vector sphere, IAtomContainer[] pathes) throws CDKException
    {
        IAtom atom = null;
        IAtom nextAtom = null;
        int atomNr;
     ...
     */
    public String listNumbers(IAtomContainer mol, @SuppressWarnings("rawtypes") Vector ac) throws java.lang.Exception
    {
        String s = "Numbers: ";
