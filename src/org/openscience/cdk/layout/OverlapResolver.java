...
public class OverlapResolver
{
	 ...
	 */
	public double displace(IAtomContainer ac, @SuppressWarnings("rawtypes") Vector overlappingAtoms, @SuppressWarnings("rawtypes") Vector overlappingBonds)
	{
		OverlapPair op = null;
	 ...
	 */
	public double getOverlapScore(IAtomContainer ac, @SuppressWarnings("rawtypes") Vector overlappingAtoms, @SuppressWarnings("rawtypes") Vector overlappingBonds)
	{
		double overlapScore = 0;
	...
	public double getAtomOverlapScore(IAtomContainer ac, @SuppressWarnings("rawtypes") Vector overlappingAtoms)
	{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public double getBondOverlapScore(IAtomContainer ac, @SuppressWarnings("rawtypes") Vector overlappingBonds)
	{
