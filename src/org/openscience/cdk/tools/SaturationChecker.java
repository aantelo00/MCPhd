...
public class SaturationChecker implements IValencyChecker, IDeduceBondOrderTool {
	 ...
	 * @see              AtomTypeFactory
	 */
	public int calculateNumberOfImplicitHydrogens(IAtom atom, double bondOrderSum, double singleElectronSum, @SuppressWarnings("rawtypes") java.util.List connectedBonds, boolean throwExceptionForUnknowAtom) 
        throws CDKException {
