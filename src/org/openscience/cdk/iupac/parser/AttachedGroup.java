...
public class AttachedGroup {
    ...
    public AttachedGroup (@SuppressWarnings("rawtypes") Vector locations, String name)
    {
    ...
    public AttachedGroup (@SuppressWarnings("rawtypes") Vector locations, int length)
    {
        setLocations (locations);
        setLength (length);
    }
     ...
     *
     */
    public void setLocations(@SuppressWarnings("rawtypes") java.util.Vector locations) {
