...
public class MoleculeBuilder
{
     ...
     * @see #addFunGroup
     */
    private void buildFunGroups(@SuppressWarnings("rawtypes") Vector attachedGroups)
    {
...
//            "\nThe parser thinks this is valid but the molecule builder has no logic for it");
     ...
     */
    private void addHeads(@SuppressWarnings("rawtypes") Vector attachedSubstituents)
    {
        @SuppressWarnings("rawtypes")
     ...
     */
    protected Molecule buildMolecule(int mainChain, @SuppressWarnings("rawtypes") Vector attachedSubstituents
    , @SuppressWarnings("rawtypes") Vector attachedGroups, boolean isMainCyclic, String name) throws
